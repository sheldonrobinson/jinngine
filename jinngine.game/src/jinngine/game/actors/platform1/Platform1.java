...
public class Platform1 extends Node implements PhysicalActor, ConfigurableActor {
	...
	public void read(Ardor3DImporter e) throws IOException {
		super.read(e);
		// read some settings
		isFixed = e.getCapsule(this).readBoolean("isFixed", false);
		shade = (float)e.getCapsule(this).readDouble("shade", 0);
	}
	...
	public void write(Ardor3DExporter e) throws IOException {
		super.write(e);		
		// write some settings
		e.getCapsule(this).write(isFixed, "isFixed", false);
		e.getCapsule(this).write(shade, "shade", 0.0);
