...
/**
 * A constraint the models contact region forces, acting between two bodies. A
 ...
 * implemented in Jinngine, see ( {@link SphereContactGenerator}).
 */
public interface ContactConstraint extends Constraint {

    /**
     * Add a new ContactGenerator for generating contact points and normal
     * vectors. This method is usually called by
     * {@link ContactConstraintManager} which takes care of dispatching
     * different contact generators for different geometry interactions. The
     * end-user should not normally be required to call this method.
     * 
     * @param g
     ...
     *            contact constraint
     */
    public void removeGenerator(Geometry g1, Geometry g2);

    /**
     * Get all contact generators in this contact constraints. This method can
     * be used to get information about the pairs of interacting pairs of
     * {@link Geometry} in this contact.
     */
