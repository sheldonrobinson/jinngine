...
/**
 * A shape that encapsulates, or bounds a given, usually more complex geometry. All geometries used in jinngine are
 * required to supply an axis aligned bounding box (AABB), because it will be used when performing broad-phase collision
 * detection
 */
public interface BoundingBox {
     ...
     * 
     * @param bounds
     *            Vector3 that will contain the updated bound values
