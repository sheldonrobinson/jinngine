...
public class ORourkeTest extends TestCase {
    ...
    public void testIntersection() {
        ...
        // setup two lines	
        final Vector3 p1 = new Vector3(0, 0, 0);
        final Vector3 p2 = new Vector3(1, 1, 0);
        final Vector3 p3 = new Vector3(0, 1, 0);
        final Vector3 p4 = new Vector3(1, 0, 0);
    ...
    public void testIntersection2() {
        ...
        final Vector3 p1 = new Vector3(0, 0, 0);
        final Vector3 p2 = new Vector3(1, 1, 0);
        final Vector3 p3 = new Vector3(1, 1, 0);
        final Vector3 p4 = new Vector3(2, 2, 0);
        final Vector3 result = new Vector3();
    ...
    public void testIntersection3() {
        ...
        final Vector3 p1 = new Vector3(0, 0, 0);
        final Vector3 p2 = new Vector3(2, 2, 0);
        final Vector3 p3 = new Vector3(0, 1, 0);
        final Vector3 p4 = new Vector3(1, 0, 0);
        final Vector3 result = new Vector3();
        ...
        final Vector3 point1 = p1.add(p2.sub(p1).multiply(result.x));
        final Vector3 point2 = p3.add(p4.sub(p3).multiply(result.y));
    ...
    public void testIsInHalfPlane() {
        ...
        // of polygons
        final Vector3 p = new Vector3(1, 1, 0);
        final Vector3 p1 = new Vector3(0, 0, 0);
        final Vector3 p2 = new Vector3(1, 0, 0);
    ...
    public void testIsContained() {
        ...
        // perform tests
        assertTrue(ORourke.isContained(x, box1));
        assertFalse(ORourke.isContained(y, box1));
        assertTrue(ORourke.isContained(z, box1));
    }
    ...
    public void testBoxBox() {
        ...
        final List<Vector3> box1 = new ArrayList<Vector3>();
        final List<Vector3> box2 = new ArrayList<Vector3>();
        final List<Vector3> result = new ArrayList<Vector3>();
        final List<Vector3> expected = new ArrayList<Vector3>();
        ...
        // run intersection
        final ORourke orourke = new ORourke();
    ...
    public void testLineBox6() {
        ...
        final List<Vector3> box1 = new ArrayList<Vector3>();
        final List<Vector3> line = new ArrayList<Vector3>();
        final List<Vector3> result = new ArrayList<Vector3>();
        final List<Vector3> expected = new ArrayList<Vector3>();
    ...
    public void testLineDiamond10() {
        ...
        final List<Vector3> diamond = new ArrayList<Vector3>();
        final List<Vector3> line = new ArrayList<Vector3>();
        final List<Vector3> result = new ArrayList<Vector3>();
        final List<Vector3> expected = new ArrayList<Vector3>();
    ...
    public void testLineLine11() {
        ...
        final List<Vector3> line1 = new ArrayList<Vector3>();
        final List<Vector3> line2 = new ArrayList<Vector3>();
        final List<Vector3> result = new ArrayList<Vector3>();
        final List<Vector3> expected = new ArrayList<Vector3>();
    ...
    private boolean verifyPolygon(final List<Vector3> poly1, final List<Vector3> poly2) {
