...
public class SupportMapContactGeneratorTest extends TestCase {
    ...
    public void testBoxBox1() {
        ...
        // contact generator
        final ContactGenerator g = new SupportMapContactGenerator(box1, box1, box2, box2);
        ...
        result.clear();
        final Result resultHandle = new Result() {
            @Override
            public void contactPoint(final Vector3 normal, final Vector3 p, final Vector3 q, final double error) {
