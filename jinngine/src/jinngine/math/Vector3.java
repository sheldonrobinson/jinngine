...
public final class Vector3 implements Serializable {
     ...
     *             if v is null
     */
    public final Vector3 add(final Vector3 v) {
     ...
     * @return resultant vector
     */
    public final Vector3 sub(final Vector3 v) {
        return new Vector3(x - v.x, y - v.y, z - v.z);
    }
     ...
     */
    public final Vector3 assignSub(final Vector3 v) {
        x -= v.x;
        y -= v.y;
        z -= v.z;
        return this;
    ...
    public final Vector3 assignAdd(final double q, final double w, final double e) {
        x += q;
        y += w;
        z += e;
        return this;
     ...
     * @return this vector
     */
    public final Vector3 assignMultiply(final double s) {
        x *= s;
        y *= s;
        z *= s;
        return this;
     ...
     * @return resultant vector
     */
    public final Vector3 multiply(final double s) {
     ...
     */
    public final Vector3 scale(final Vector3 s) {
     ...
     */
    public static final double normOfDifference(final Vector3 a, final Vector3 b) {
     ...
     */
    public static final double xynormOfDifference(final Vector3 a, final Vector3 b) {
     ...
     */
    public static final double squaredNormOfDifference(final Vector3 a, final Vector3 b) {
     ...
     * Return the norm of a+b
     */
    public static final double normOfSum(final Vector3 a, final Vector3 b) {
        return Math.sqrt((a.x + b.x) * (a.x + b.x) + (a.y + b.y) * (a.y + b.y) + (a.z + b.z) * (a.z + b.z));
    }
     ...
     * Return the squared norm of a+b
     */
    public static final double squaredNormOfSum(final Vector3 a, final Vector3 b) {
        return (a.x + b.x) * (a.x + b.x) + (a.y + b.y) * (a.y + b.y) + (a.z + b.z) * (a.z + b.z);
    }
     ...
     */
    public final static void multiply(final Vector3 v, final double s) {
        v.x *= s;
        v.y *= s;
        v.z *= s;
    }
     ...
     */
    public final static void multiplyAndAdd(final Vector3 v, final double s, final Vector3 r) {
        r.x += v.x * s;
        r.y += v.y * s;
        r.z += v.z * s;
    }
     ...
     */
    public final static void multiplyAndAdd(final Matrix3 A, final Vector3 v, final double s, final Vector3 r) {
     ...
     * r = r + Av
     */
    public final static void transformAndAdd(final Matrix3 A, final Vector3 v, final Vector3 r) {
     ...
     */
    public static void multiplyStoreAndAdd(final Vector3 v, final double s, final Vector3 result) {
        v.x *= s;
        v.y *= s;
        v.z *= s;
        result.x += v.x;
     ...
     *             if v is null
     */
    public final double dot(final Vector3 v) {
     ...
     * @throws NullPointerException
     */
    public final double xydot(final Vector3 v) {
        return x * v.x + y * v.y;
    }
    ...
    public final Vector3 assignCross(final Vector3 v) {
        ...
        final double tmpy = z * v.x - x * v.z;
        final double tmpz = x * v.y - y * v.x;
        x = tmpx;
        y = tmpy;
        z = tmpz;
        return this;
     ...
     * @return return this
     */
    public final Vector3 assign(final double x, final double y, final double z) {
        this.x = x;
        this.y = y;
        this.z = z;
        return this;
     ...
     */
    public final Vector3 add(final double x, final double y, final double z) {
     ...
     * @throws NullPointerException
     */
    public final Vector3 assign(final Vector3 v) {
        final double t1 = v.x;
        final double t2 = v.y;
        final double t3 = v.z;
        x = t1;
     ...
     * @return
     */
    public final Vector3 assignScale(final double xs, final double ys, final double zs) {
        x *= xs;
        y *= ys;
        z *= zs;
        return this;
     ...
     */
    public final Vector3 assignAddProduct(final Vector3 v, final double s) {
        x += v.x * s;
        y += v.y * s;
        z += v.z * s;
        return this;
    ...
    public static double[] toArray(final Collection<Vector3> vectors) {
        // convert points
        final double[] array = new double[3 * vectors.size()];
        int i = 0;
